...
function QSP_evolution_op(
    ...
    for ki in 1:n_intervals
        ...
        for j in 1:nt
            ...
            PauliOperators.coeff_clip!(Wt; thresh=1e-12)
            ...
            # Apply pruning
            PauliOperators.coeff_clip!(Wt; thresh=thresh)
            PauliOperators.weight_clip!(Wt; max_weight=max_weight)
...
@test check_spv(result_sparse.final_operator)
