...
function run_dip()
    ...
    data_path = "/Users/admin/PycharmProjects/pyQCTools/QSP/Ethylene_and_polyenes/P2-RHF_dip_mo.npz"
...
title!(plt, "P2(4e,4o) ,dt=$dt")
savefig(plt, "QSP_P2_exact.pdf")

println("- - - Sanity Check: saving signal - - - ")
open("/Users/admin/VSCProjects/QuantumChemQC/QSP/QSP_P2_exact_signals.txt", "w") do io
