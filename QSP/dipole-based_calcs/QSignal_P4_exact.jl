...
function run_dip()
    ...
    data_path = "/Users/admin/PycharmProjects/pyQCTools/QSP/Ethylene_and_polyenes/P4-RHF_dip_mo.npz"
...
function run_H()
    ...
    data_path =  "/Users/admin/PycharmProjects/pyQCTools/QSP/Ethylene_and_polyenes/P4-RHF_integrals.npz"
    data = npzread(data_path)
    H0 = data["hc"][1]
    H1 = data["h1e"]
    H2 = data["h2e"]
...
title!(plt, "P4(8e,8o) ,dt=$dt")
savefig(plt, "QSP_P4_exact.pdf")

println("- - - Sanity Check: saving signal - - - ")
open("/Users/admin/VSCProjects/QuantumChemQC/QSP/QSP_P4_exact_signals.txt", "w") do io
