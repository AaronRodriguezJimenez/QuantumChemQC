...
#=const BASE = "/Users/admin/PycharmProjects/pyQCTools/QSP/H4-PP/NO-UCCSD_tensors" # UCCSD natural orbitals
const CASES = [
    (0.50, joinpath(BASE, "Natural_UCCSD_H4_D4_R_0p5_tensors.npz"))
    (0.7414, joinpath(BASE, "Natural_UCCSD_H4_D4_R_0p7414_tensors.npz"))
    (1.00, joinpath(BASE, "Natural_UCCSD_H4_D4_R_1p0_tensors.npz"))
    (1.50, joinpath(BASE, "Natural_UCCSD_H4_D4_R_1p5_tensors.npz"))
    (2.00, joinpath(BASE, "Natural_UCCSD_H4_D4_R_2p0_tensors.npz"))
    (2.50, joinpath(BASE, "Natural_UCCSD_H4_D4_R_2p5_tensors.npz"))
    (3.00, joinpath(BASE, "Natural_UCCSD_H4_D4_R_3p0_tensors.npz"))
]=#
...
#=const BASE = "/Users/admin/PycharmProjects/pyQCTools/QSP/H4-PP/NO-UCCSD_tensors" # UCCSD natural orbitals
const CASES = [
    (0.50, joinpath(BASE, "Natural_UCCSD_H4_LIN4_R_0p5_tensors.npz"))
    (0.7414, joinpath(BASE, "Natural_UCCSD_H4_LIN4_R_0p7414_tensors.npz"))
    (1.00, joinpath(BASE, "Natural_UCCSD_H4_LIN4_R_1p0_tensors.npz"))
    (1.50, joinpath(BASE, "Natural_UCCSD_H4_LIN4_R_1p5_tensors.npz"))
    (2.00, joinpath(BASE, "Natural_UCCSD_H4_LIN4_R_2p0_tensors.npz"))
    (2.50, joinpath(BASE, "Natural_UCCSD_H4_LIN4_R_2p5_tensors.npz"))
    (3.00, joinpath(BASE, "Natural_UCCSD_H4_LIN4_R_3p0_tensors.npz"))
]=#
...
#=const BASE = "/Users/admin/PycharmProjects/pyQCTools/QSP/H4-PP/NO-UCCSD_tensors" # UCCSD natural orbitals
const CASES = [
    (0.50, joinpath(BASE, "Natural_UCCSD_H4_S4_R_0p5_tensors.npz"))
    (0.7414, joinpath(BASE, "Natural_UCCSD_H4_S4_R_0p7414_tensors.npz"))
    (1.00, joinpath(BASE, "Natural_UCCSD_H4_S4_R_1p0_tensors.npz"))
    (1.50, joinpath(BASE, "Natural_UCCSD_H4_S4_R_1p5_tensors.npz"))
    (2.00, joinpath(BASE, "Natural_UCCSD_H4_S4_R_2p0_tensors.npz"))
    (2.50, joinpath(BASE, "Natural_UCCSD_H4_S4_R_2p5_tensors.npz"))
    (3.00, joinpath(BASE, "Natural_UCCSD_H4_S4_R_3p0_tensors.npz"))
]=#

#=const BASE = "/Users/admin/PycharmProjects/pyQCTools/QSP/H4-PP/MEAO-tensors" # MEAO natural orbitals
const CASES = [
    (0.50, joinpath(BASE, "h4_MEAO_S4_R_0p5_tensors.npz"))
    (0.7414, joinpath(BASE, "h4_MEAO_S4_R_0p7414_tensors.npz"))
    (1.00, joinpath(BASE, "h4_MEAO_S4_R_1_tensors.npz"))
    (1.50, joinpath(BASE, "h4_MEAO_S4_R_1p5_tensors.npz"))
    (2.00, joinpath(BASE, "h4_MEAO_S4_R_2_tensors.npz"))
    (2.50, joinpath(BASE, "h4_MEAO_S4_R_2p5_tensors.npz"))
    (3.00, joinpath(BASE, "h4_MEAO_S4_R_3_tensors.npz"))
]=#
