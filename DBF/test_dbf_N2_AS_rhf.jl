...
function run()
    ...
    # Test for ccpvdz
    data_path = "/Users/admin/PycharmProjects/pyQCTools/tests/N2_tensors_rhf_stable/1.5_tensors.npz"
...
function dbf_gstate(H::PauliSum{N, T}) where {N,T}
    ...
    ket, occ, kidx  = string_to_ket("11111111110000000000000000000000000000000000000000000000") #Leading CAS/ccpvdz (interleaved)
